...
#define UE_PROJECT_NAME NetShootRewrite
#define UE_TARGET_NAME NetShootRewriteEditor
#define UE_MODULE_NAME "NetShootRewrite"
...
#define NETSHOOTREWRITE_API DLLEXPORT
